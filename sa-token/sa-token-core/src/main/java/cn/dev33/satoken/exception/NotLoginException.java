...
public class NotLoginException extends SaTokenException {
	...
	public static final String NOT_TOKEN_MESSAGE = "failed to read valid token";
	...
	public static final String TOKEN_TIMEOUT_MESSAGE = "token expired";
	
	/** 表示 token 已被顶下线 */
	public static final String BE_REPLACED = "-4";
	public static final String BE_REPLACED_MESSAGE = "token has been taken offline";
	
	/** 表示 token 已被踢下线 */
	public static final String KICK_OUT = "-5";
	public static final String KICK_OUT_MESSAGE = "token kicked offline";

	/** 表示 token 已被冻结 */
	public static final String TOKEN_FREEZE = "-6";
	public static final String TOKEN_FREEZE_MESSAGE = "token frozen";

	/** 表示 未按照指定前缀提交 token */
	public static final String NO_PREFIX = "-7";
	public static final String NO_PREFIX_MESSAGE = "not submitted according to the specified prefix token";

	/** 默认的提示语 */
	public static final String DEFAULT_MESSAGE = "the current session is not logged in";
